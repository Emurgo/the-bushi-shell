...
## Pi Case Anaylsis 
 ...
 - Here is a comparison list of all different hardware and software specs of all the devices currently in the community and their physical pros and cons:
     ...
     ---- | ------- | -------------- | -------------- | ----------------
     Reddcoin Case (Snap-on design) | ![Reddcoin](https://cdn.shopify.com/s/files/1/2685/8754/products/Reddcoin_960x960.png?v=1518785883) | Stake Box Case | Easy access to all ports / Shake-proof / No tools needed / Professional appearance | Requires percise design 
     Sleeve Case (Sleeve design) | ![Sleeve](https://cdn.thingiverse.com/renders/14/c5/00/85/15/IMGP0789_preview_featured.jpg) |  Raspberry Pi Case | Simple Design / Easy to print  | Requires constant Z-axis leveling / Easily opens
     VESA (Screw design) | ![Vesa](https://cdn.thingiverse.com/renders/b8/00/d0/e2/72/30mm-no-fan_preview_featured.jpg) | Raspberry Pi Case | Able to be installed onto different surfaces | Requires tools to maintenance / Ware of material (especially plastic)
