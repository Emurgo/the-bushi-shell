...
## Pi Case Anaylsis 
 ...
 - Here is a comparison list of all different hardware and software specs of all the devices currently in the community and their physical pros and cons:
   ...
   ---- | ------- | -------------- | -------------- | ----------------
   Current Staking Cases | <img src = "https://cdn.shopify.com/s/files/1/2685/8754/products/Reddcoin_960x960.png?v=1518785883" height = 80 weight = 100> | Snap-on Lock | Easy access to all ports / Shake-proof / No tools needed / Professional appearance | Requires percise design 
